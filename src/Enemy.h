...
struct EnemyConfig{
    ...
    float acceleration; /* �������ٶ� px/s^2 */
    float minPlayerDist; /* �������С���� */
    int enemyType;
    int enemyID;
    bool isMidboss;
};
...
private:
    ...
    float moveAngle; /* ��ǰ�˶��Ƕ� (����) */
    float angularVelocity; /* ���ٶ� (rad/s) */
    float accel; /* �������ٶ� (px/s^2) */
    float minPlayerDist; /* ����ұ��ֵ���С���� */
    float moveMinX, moveMaxX, moveMinY, moveMaxY;
    bool  hasMoveBounds;
    int spriteRow; /* ����ͼ������ (0-15) */
    float spriteAnimTimer; /* ������ʱ�� */
    float clamp(float value, float min_, float max_);
    float cubic_bezier(float t, float p0, float p1, float p2, float p3);
    void compute_axis_speed(); /* ���� movePattern ���� axisSpeed */
    float axisSpeedX; /* ��֡�ٶ� x ���� */
    float axisSpeedY; /* ��֡�ٶ� y ���� */
