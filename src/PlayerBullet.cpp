...
static PlayerBulletConfig g_Rank1_Bullets[] = {
	{5, 0, 0, 12, 48, -1.5708f, 12.0f, 20, 0, 0, 0, 0, 0, 0, 0, 0},
};

static PlayerBulletConfig g_Rank2_Bullets[] = {
	{5, 0, 0, 12, 48, -1.5708f, 12.0f, 20, 0, 0, 0, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -2.8798f, 10.0f, 7, 1, 1, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -0.2618f, 10.0f, 7, 1, 2, -1, 0, 0, 0, 0, 0},
};

static PlayerBulletConfig g_Rank3_Bullets[] = {
	{5, -4, 0, 12, 48, -1.5882f, 12.0f, 15, 0, 0, -1, 0, 0, 0, 0, 0},
	{5, 4, 0, 12, 48, -1.5533f, 12.0f, 15, 0, 0, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -2.8798f, 10.0f, 7, 1, 1, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -0.2618f, 10.0f, 7, 1, 2, -1, 0, 0, 0, 0, 0},
};

static PlayerBulletConfig g_Rank4_Bullets[] = {
	{5, 0, 0, 12, 48, -1.6755f, 12.0f, 12, 0, 0, 0, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -1.5708f, 12.0f, 15, 0, 0, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -1.4661f, 12.0f, 12, 0, 0, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -2.8798f, 10.0f, 7, 1, 1, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -0.2618f, 10.0f, 7, 1, 2, -1, 0, 0, 0, 0, 0},
};
...
static PlayerBulletConfig g_Rank5_Bullets[] = {
	...
	{5, 0, 0, 12, 48, -1.5708f, 12.0f, 15, 0, 0, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -1.4661f, 12.0f, 12, 0, 0, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -2.8798f, 10.0f, 6, 1, 1, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -0.2618f, 10.0f, 6, 1, 2, -1, 0, 0, 0, 0, 0},
};

static PlayerBulletConfig g_Rank6_Bullets[] = {
	{5, 0, 0, 12, 48, -1.5882f, 12.0f, 12, 0, 0, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -1.5708f, 12.0f, 14, 0, 0, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -1.5533f, 12.0f, 12, 0, 0, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -2.8798f, 10.0f, 5,  1, 1, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -0.2618f, 10.0f, 5,  1, 2, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -2.8798f, 10.0f, 6, 1, 1, -1, 0, 0, 0, 0, 0},
	{5, 0, 0, 12, 48, -0.2618f, 10.0f, 6, 1, 2, -1, 0, 0, 0, 0, 0},
};
